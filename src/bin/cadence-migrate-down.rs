//! Database migration rollback tool for Cadence.
//!
...
const USAGE: &str = r#"Usage: cadence-migrate-down --database-url <URL>

Revert the most recent database migration for Cadence.

Arguments:
  --database-url <URL>    PostgreSQL database connection URL

Example:
  cadence-migrate-down --database-url postgres://user:pass@localhost/cadence
